...
object Messages : SettingsHolder {
    ...
    val NOT_ENOUGH_MONEY = Property.create("&cYou do not have enough money!")
    ...
    @Comment(
        ...
        "These placeholder shows how many seconds are left until the player's cooldown is going to expire."
    )
    ...
    val COOLDOWN_REMAINING_TARGET = Property.create("&c%player_name% has %cooldown% seconds of cooldown left.")
}